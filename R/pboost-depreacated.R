#' @name pboost-deprecated
#' @title [Deprecated] Profile Boosting Framework
#' 
#' @description
...
#' @rdname pboost-deprecated
#' @order 1
#' @export
pboost.deprecated <- function(formula, data, fitFun, scoreFun, stopFun, ...,
